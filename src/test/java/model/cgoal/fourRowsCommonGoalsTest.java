...
class fourRowsCommonGoalsTest {
    ...
    void checker() {
        ...
        l1.add(2);
        l1.add(3);
        CommonGoals test6 = new fourRowsCommonGoals(l1);
        test6.printLayout();
        Assertions.assertEquals(3,test6.getCurrent_point() );
        ...
        matrix[5][4] = a54;
        assertEquals(3, test6.Checker(matrix));
