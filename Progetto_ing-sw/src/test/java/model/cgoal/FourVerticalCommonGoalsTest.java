...
class FourVerticalCommonGoalsTest {
    ...
    void checker() {
        ...
        matrix[0][2] = a02;
        Tile a03 = new Tile(COLOR.BLANK, 1);
        matrix[0][3] = a03;
        Tile a04 = new Tile(COLOR.BLANK, 1);
        matrix[0][4] = a04;
        ...
        matrix[5][1] = a51;
        Tile a52 = new Tile(COLOR.BLUE, 1);
        matrix[5][2] = a52;
        ...
        assertEquals(1, this.test7.Checker(matrix));
        for(int i = 0; i < 6; ++i) {
            for(int j = 0; j < 5; ++j) {
        ...
        assertEquals(0, this.test7.Checker(matrix));
