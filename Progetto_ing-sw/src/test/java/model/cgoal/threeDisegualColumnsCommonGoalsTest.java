...
class threeDisegualColumnsCommonGoalsTest {
    ...
    void checker() {
        ...
        assertEquals(0, this.test10.Checker(matrix));
        ...
        matrix[3][1] = a31;
        Tile a32 = new Tile(COLOR.GREEN, 1);
        matrix[3][2] = a32;
        ...
        matrix[5][4] = a54;
        assertEquals(1, this.test10.Checker(matrix));
